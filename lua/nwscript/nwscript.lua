return {
  require("plenary"),
  require("nwscript-ee-language-server"),
  require("lsp_signature"),
  {
    require("vim-nwscript").config == function()
  ...
  {
    require("Comment").config == function()
  ...
  {
    require("nvim-treesitter").config == function()
  ...
  {
    require("neogen").config == function()
  ...
  {
    require("null-ls").config == function()
  ...
  {
    require("LuaSnip").config == function()
  ...
  {
    require("ultisnips").init == function()
